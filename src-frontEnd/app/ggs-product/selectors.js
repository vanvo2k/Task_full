...
export const getFilterMinPriceData = createSelector(getMetaListItems, state => state.get('minPrice'));

export const getFilterMaxPriceData = createSelector(getMetaListItems, state => state.get('maxPrice'));
...
export const getFullMetaData = createSelector(getMetaListItems, state => {
    ...
    const minPrice = state.getIn(['minPrice', 'current']);
    const maxPrice = state.getIn(['maxPrice', 'current']);
    ...
    return {
        ...
        filter: {
            ...
            minPrice: {
                from: minPrice.get('from'),
                to: minPrice.get('to')
            },
            maxPrice: {
                from: maxPrice.get('from'),
                to: maxPrice.get('to')
            },
        },
        sort: {
