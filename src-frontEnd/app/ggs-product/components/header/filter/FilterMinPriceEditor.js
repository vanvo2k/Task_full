...
class FilterMinPriceEditor extends Component {
    state = {
        from: null,
        to: null,
    };
    ...
    render() {
        ...
        return (
            <div className={classNames(["FilterMinPriceEditor", className])}>
                <Popover className={className} placement="bottom" isOpen={isOpen} target="FilterMinPrice"
                         toggle={this._handleToggle.bind(this)}>
                    <PopoverHeader><FormattedMessage id="searchItem.header.price_is_between"/></PopoverHeader>
                    <PopoverBody>
                        <Form className="FormFilterMinPrice" inline onKeyUp={this._handleSubmitForm.bind(this)}>
                            <FormGroup>
...
FilterMinPriceEditor.propTypes = {
...
export default FilterMinPriceEditor;