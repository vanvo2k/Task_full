...
class AnalyticsKeyword extends Component {
    ...
    render() {
        ...
        const {searchType, market,userScope} = this.props
                        ...
                        <div className="Details">
                            <div className="row">
                                ...
                                <div className="col-2 Analytic">
                                    <b>Trending</b>
                                    <div className="Value">
                                        <p>{isUserTrial?"******":formatThousandNumber(trending.up + trending.down)}</p>
                                    </div>
                                    <h6>up/down: {isUserTrial?"******":formatThousandNumber(trending.up)}/{isUserTrial?"******":formatThousandNumber(trending.down)}</h6>
                                </div>
                                <div className="col-2 Analytic">
                                    <b>Has rank</b>
                                    <div className="Value">
                                        <p>{isUserTrial?"******":formatThousandNumber(rank.has)}</p>
                                    </div>
                                    <h6>({isUserTrial?"******":percentHasRankValidated}%)</h6>
                                </div>
                                <div className="col-2 Analytic">
                                    <b>{"Rank < 500k"}</b>
                                    <div className="Value">
                                        <p>{isUserTrial?"******":formatThousandNumber(_totalHasRankLessThan500k)}</p>
                                    </div>
                                </div>
                                <div className="col-2 Analytic">
                                    <b>Average Ranking</b>
                                    <div className="Value">
                                        <p>{isUserTrial?"******":formatThousandNumber(rankAvg)}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
