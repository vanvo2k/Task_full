...
class ChartPriceItem extends Component {
    constructor(props) {
        super(props);
    ...
    _getData() {
        ...
        const data = computedRanks.map(price => {
...
ChartPriceItem.defaultProps = {
    height: 100,
    historyDays: 0,
    filtering: false,
};

ChartPriceItem.propTypes = {
