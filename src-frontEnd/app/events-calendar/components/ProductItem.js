            ...
            <div
                ...
                <div className="FavoriteAndIgnore">
                    ...
                    <div className="Thumbnail">
                        <Link to={`/a/items/${_id}`}
                              style={{backgroundImage: "url(" + previewUrl + ")"}} onClick={()=>{this.props.actionCloseEventDetail()}}>
                ...
                <div className="Bottom">
                    ...
                    <Link className="Name" to={`/a/items/${_id}`} onClick={()=>{this.props.actionCloseEventDetail()}}>{name}</Link>
                    <div className="Brand">
                        <span className="Title">Brand: </span>
                        <span className="Value"><a
                            target="_blank"
                            href={`/a/items?page=1&term=brand:${encodeURIComponent(brand)}&sortByField=rank&searchType=match_phrase`} onClick={()=>{this.props.actionCloseEventDetail()}}>{brand}</a>
